...
{{--            <div class="badge-round-red">2</div>--}}
        ...
        <div id="bottomNavFiltersBtn">
            <svg viewBox="0 0 23 22"><use href="#filtersIcon" /></svg>
            Фильтры
        </div>
        {{--<a href="#">
    ...
    @include('includes.footer.bottom-nav-menu')

    @include('includes.footer.bottom-nav-filters')

    @include('includes.footer.bottom-nav-profile')
</div>