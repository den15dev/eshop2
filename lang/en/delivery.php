...
return [
    "conditions" => [
        "access_roads" => "Purchased goods are delivered to the apartment (cottage) only if there are access roads to the entrance of the house (cottage). In two-level apartments, multi-store cottages and dachas, goods are placed on the first floor.",
